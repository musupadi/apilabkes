...
// $config['auth_override_class_method_http']['users']['users']['post'] = 'none';
// $config['auth_override_class_method_http']['users']['users']['get'] = 'none';
// $config['auth_override_class_method_http']['users']['confirm_email']['get'] = 'none';
// $config['auth_override_class_method_http']['users']['checkcode']['post'] = 'none';
// $config['auth_override_class_method_http']['users']['read_only']['post'] = 'none';
// $config['auth_override_class_method_http']['geos']['geos']['get'] = 'none';
// $config['auth_override_class_method_http']['geos']['checkgeoscode']['post'] = 'none';
// $config['auth_override_class_method_http']['geos']['geos_subdivision_types']['get'] = 'none';
// $config['auth_override_class_method_http']['checklist_items']['checklist_items']['get'] = 'none';
// $config['auth_override_class_method_http']['user_areas']['user_areas']['get'] = 'none';
// $config['auth_override_class_method_http']['user_area_reports']['user_area_reports']['get'] = 'none';
// $config['auth_override_class_method_http']['user_area_reports']['user_area_reports']['post'] = 'none';
// $config['auth_override_class_method_http']['user_area_reports']['user_area_reports']['patch'] = 'none';
// $config['auth_override_class_method_http']['user_area_reports']['user_area_reports']['options'] = 'none';
// $config['auth_override_class_method_http']['user_area_reports']['user_area_reports_graphs']['get'] = 'none';
// $config['auth_override_class_method_http']['user_areas']['user_areas']['options'] = 'none';

//POST
//Non Capital
$config['auth_override_class_method_http']['labkes']['login']['post'] = 'none';
$config['auth_override_class_method_http']['labkes']['tambahpasien']['post'] = 'none';
$config['auth_override_class_method_http']['labkes']['hematologi']['post'] = 'none';
$config['auth_override_class_method_http']['labkes']['kimiadarah']['post'] = 'none';
$config['auth_override_class_method_http']['labkes']['urinalisa']['post'] = 'none';
$config['auth_override_class_method_http']['labkes']['sedimen']['post'] = 'none';
$config['auth_override_class_method_http']['labkes']['immunoserologi']['post'] = 'none';
...
//GET
//Non Capital
$config['auth_override_class_method_http']['labkes']['datapasien']['get'] = 'none';
$config['auth_override_class_method_http']['labkes']['laporan']['get'] = 'none';
$config['auth_override_class_method_http']['labkes']['countlaporan']['get'] = 'none';
$config['auth_override_class_method_http']['labkes']['laporanexcel']['get'] = 'none';
...
|
*/
$config['rest_keys_table'] = 'user_api_keys';
...
|
*/
$config['rest_language'] = defined('CURRENT_LANGUAGE_LONG') ? CURRENT_LANGUAGE_LONG : 'english';
...
|
*/
$config['allowed_cors_origins'] = ['http://localhost:8100', 'http://localhost:8101', 'http://localhost:8102'];
